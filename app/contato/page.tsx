      ...
      <main className="pt-40 pb-20 px-8 md:px-20 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg border border-[#1a2e22]/5">
                ...
                {/* --- MAPA INCORPORADO AQUI --- */}
                <div className="w-full h-80 rounded-lg overflow-hidden shadow-sm border border-[#1a2e22]/10">
                    <iframe 
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1513.9548032615073!2d-47.4367974194675!3d-23.533010203680167!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94cf61c240330dff%3A0xb020f23d4e307616!2sR.%20Ant%C3%B4nio%20Scarpa%20Pach%C3%AAco%20Leite%2C%20330%20-%20Jardim%20Sao%20Luis%2C%20Votorantim%20-%20SP%2C%2018112-750!5e0!3m2!1spt-BR!2sbr!4v1770864782397!5m2!1spt-BR!2sbr" // Seu link inserido aqui
                        width="100%" 
                        height="100%" 
                        style={{ border: 0 }} 
                        allowFullScreen 
